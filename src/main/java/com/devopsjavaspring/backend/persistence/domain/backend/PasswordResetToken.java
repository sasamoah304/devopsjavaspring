...
import com.devopsjavaspring.backend.persistence.converters.LocalDateTimeAttributeConverter;
...
public class PasswordResetToken implements Serializable{
     ...
     * @param expirationInMinutes The length in minutes for which this token will be valid. If zero, it be assigned
     *                            a default value of 120 (2 hours)
