...
/**
 * Created by stephenasamoah on 9/13/16.
 */
@Service
...
//            throw new S3Exception("The file " + resource.getAbsolutePath() + " doesn't exist");
        ...
        if (null == rootBucketUrl) {
            ...
            try {
                LOG.debug("Bucket Name for S3 Service is {}", bucketName);
                LOG.debug("Key Name for S3 Service is {}", key);
                LOG.debug("Resource Name for S3 Service is {}", resource);
